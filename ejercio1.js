  ...
  const Ejercicio3 = ()=>{ // funciona correctamente
      ...
      const Ejercicio4 =()=>{     //No esta termiando
           ...
           /*
            ...
            const Apellido = prompt("Digite el Apellido")
         ...
         let hombre= [n_estudiante_H];
         let mujeres=[n_estudiante_M];
         
  
         
         for(let i =0 ; i<n_estudiante_H; i++){
  
            let nombre_h = prompt("Nombre del estudiante Hombre"+(i+1)+":")
            let edad_h = parseInt(prompt("Digite la edad del estudiante " + nombre_h))
            datos_h ={
            edad_h
         }  
         
         hombre.push(datos_h)
         let suma =  parseInt(hombre.reduce((previous, current)=> current+=previous)) ;
         let promedio_m=parseFloat( suma/hombre.length);
         console.log(promedio_m)
         
         
               }
               console.log(suma)
               console.log(hombre)
              // promedio_h= parseInt((edad_h[i]) n_estudiante_H)
  ...
  const Ejercicio15 = () => { //Funciona todo
    ...
    var N_años = 0, final=0 ;
      ...
      while (Pais_A>Pais_B) {
          ...
          const ejercicio5 = ()=>{ //funciona todo
          ...
          */   
           ...
           let productList = [];
            ...
            const persona = arreglo.find(pers=> pers.nombre==="tomas");
            if (persona) {
              console.log("el nombre de esa persona ya existe")
            }
            */
          }
         // ejercicio5();
